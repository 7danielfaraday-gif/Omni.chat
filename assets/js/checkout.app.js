...
const CHECKOUT_OPEN_EVENT_PREFIX = '__checkout_open_event__';
...
return { min: 4, max: 7 };
 ...
 // Controle de ViewContent por sessão
 ...
 // reaproveita o ID dentro da sessão para evitar duplicidade local.
...
const progress = Math.min((filledFields / totalFields) * 100, 100);
 ...
 // Mantido apenas por compatibilidade de interface.
...
e("p", {className: "text-center text-[11px] text-slate-300 font-mono mt-3"}, "ID: " + transactionId)
 ...
 '<div style="font-size:13px;color:#475569;max-width:420px;line-height:1.4;">Tente recarregar a página. Se estiver no navegador do app embutido, às vezes ajuda abrir no Chrome/Safari.</div>' +
